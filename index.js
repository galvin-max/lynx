...
const instagram = 'https://instagram.com/id.galvin'; 
const telegram = 'https://t.me/vers'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCQ31qUqeEyT403S_KC0RnYA';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@id.galvin`)
})
